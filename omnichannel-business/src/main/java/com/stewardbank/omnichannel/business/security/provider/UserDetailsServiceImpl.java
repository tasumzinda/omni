...
package com.stewardbank.omnichannel.business.security.provider;
...
public class UserDetailsServiceImpl implements org.springframework.security.core.userdetails.UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String userName)
        ...
        com.stewardbank.omnichannel.business.domain.User user = (com.stewardbank.omnichannel.business.domain.User) userService.findByUserName(userName);
        if (user != null) {
