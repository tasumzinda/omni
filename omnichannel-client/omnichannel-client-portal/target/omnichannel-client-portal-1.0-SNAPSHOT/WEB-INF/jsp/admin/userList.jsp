                                        ...
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <c:forEach var="item" items="${items}" >
                                                    <tr>
                                                        <td><a href="user.form?id=${item.id}">${item.firstName}</a></td>
                                                        <td><a href="user.form?id=${item.id}">${item.lastName}</a></td>
                                                        <td><a href="user.form?id=${item.id}">${item.userName}</a></td>
                                                        <td>
                                                            <a href="user.form?id=${item.id}"><button class="btn btn-success">Edit</button></a>
                                                        </td>
                                                    </tr>
                                                </c:forEach>
                                            </tbody>
