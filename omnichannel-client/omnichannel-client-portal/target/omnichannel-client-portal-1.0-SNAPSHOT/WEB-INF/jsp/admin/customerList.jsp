...
<html>
    <head>
        ...
        <title>Steward Bank |Accounts </title>
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-footer">
                                        ...
                                        <div class="pull-right">
                                            <a href="${page}/logout" class="btn btn-success">Sign out</a>
                                        </div>
                                    </li>
                                </ul>
                            </li>
                                            ...
                                            <tbody>
                                                <c:forEach var="item" items="${items}" >
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="item.form?id=${item.id}"><button class="btn btn-success">Edit Record</button></a>
                                                        </td>
                                                        <td>
                                                            <a href="audit-report?id=${item.id}" target="blank"><button class="btn btn-success">Generate Audit Report</button></a>
                                                        </td>
                                                    </tr>
                                                </c:forEach>
                                            </tbody>
