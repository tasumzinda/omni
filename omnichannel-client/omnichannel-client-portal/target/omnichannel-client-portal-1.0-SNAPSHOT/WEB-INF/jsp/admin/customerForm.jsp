            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="item.form">New Customer</a></li>
                        <li class="active"><a href="item.list">Customer List</a></li>
                    </ol>
                </section>
                                        ...
                                        <form:form commandName="item" action="item.form">
                                            <div class="form-group">
                                                ...
                                                <div class="help-block has-success">
                                                    <p style="color: red"><form:errors path="firstName" class="has-success"/></p>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="help-block has-success">
                                                    <p style="color: red"><form:errors path="lastName" class="has-success"/></p>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="help-block has-success">
                                                    <p style="color: red"><form:errors path="address" class="has-success"/></p>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label" for="inputSuccess"><i class="fa fa-check"></i>Card Number</label>
                                                <form:input path="cardNumber" class="form-control"/>
                                                <div class="help-block has-success">
                                                    <p style="color: red"><form:errors path="cardNumber" class="has-success"/></p>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label" for="inputSuccess"><i class="fa fa-check"></i>Phone Number</label>
                                                <form:input path="phoneNumber" class="form-control"/>
                                                <div class="help-block has-success">
                                                    <p style="color: red"><form:errors path="phoneNumber" class="has-success"/></p>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label" for="inputSuccess"><i class="fa fa-check"></i>ID Number</label>
                                                <form:input path="idNumber" class="form-control"/>
                                                <div class="help-block has-success">
                                                    <p style="color: red"><form:errors path="idNumber" class="has-success"/></p>
                                                </div>
                                            </div>
