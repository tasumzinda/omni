...
<html>
    <head>
        ...
        <title>Steward Bank | Log in</title>
        ...
        <div class="login-box">
            <div class="login-logo">
                <p style="color: #4E004E"><b>Admin</b>LOGIN</p>
            </div>
            <!-- /.login-logo -->
            <div class="login-box-body">
                <p class="login-box-msg" style="color: #4E004E"><b>Sign in to start your session</b></p>
                <%@include file="admin/message.jspf" %>
                <form action="<c:url value="j_spring_security_check"/>" method="post">
                    <div class="form-group has-feedback">
                        <input type="text" name='j_username' id="username" class="form-control" placeholder="Email">
