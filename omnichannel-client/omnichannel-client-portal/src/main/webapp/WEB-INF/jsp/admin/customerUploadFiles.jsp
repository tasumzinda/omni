                ...
                <section class="sidebar">
                    ...
                    <div class="user-panel">
                        <div class="pull-left image">
                            <img src="<c:url value="/resources/dist/avatar5.png"/>" class="img-circle" alt="User Image">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="user.form">New User</a></li>
                                    ...
                                    <div class="box-body">
                                        <form action="save-file" method="post" enctype="multipart/form-data">
                                            <div class="form-group">
                                                <label class="control-label" for="inputSuccess"><i class="fa fa-check"></i>Signature</label>
                                                <input type="file" name="signatureFilePath" class="form-control"/>
                                                <div class="help-block has-success">
                                                    <form:errors path="signatureFilePath" class="has-success"/>
                                                </div>
                                            </div>
                                                <div class="form-group">
                                                <label class="control-label" for="inputSuccess"><i class="fa fa-check"></i>Head shot</label>
                                                <input type="file" name="headshotFilePath" class="form-control"/>
                                                <div class="help-block has-success">
                                                    <form:errors path="headshotFilePath" class="has-success"/>
                                                </div>
                                            </div>
                                                <div class="form-group">
                                                <label class="control-label" for="inputSuccess"><i class="fa fa-check"></i>ID</label>
                                                <input type="file" name="idFilePath" class="form-control"/>
                                                <div class="help-block has-success">
                                                    <form:errors path="idFilePath" class="has-success"/>
                                                </div>
                                            </div>
                                                <div class="form-group">
                                                <label class="control-label" for="inputSuccess"><i class="fa fa-check"></i>Proof Of Residence</label>
                                                <input type="file" name="proofOfResidenceFilePath" class="form-control"/>
                                                <div class="help-block has-success">
                                                    <form:errors path="proofOfResidenceFilePath" class="has-success"/>
                                                </div>
                                            </div>
                                                <div class="form-group">
                                                    <input type="hidden" name="idNumber" class="form-control" value="${idNumber}"/>
                                            </div>
                                            <div class="box-footer">
                                                <a href="${itemDelete}"><button type="submit" class="btn btn-default">Cancel</button></a>
