...
<html>
    <head>
        ...
        <title>Steward Bank |Accounts | User</title>
                                    ...
                                    <div class="box-body">
                                        <form:form commandName="item" action="user.form">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="help-block has-success">
                                                    <p style="color: red"><form:errors path="userName" class="has-success"/></p>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="help-block has-success">
                                                    <p style="color: red"><form:errors path="password" class="has-success"/></p>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="help-block">
                                                    <p style="color: red"><form:errors path="confirmPassword" class="has-success"/></p>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="help-block">
                                                    <p style="color: red"><form:errors path="userRoles" class="alert-danger"/></p>
                                                </div>
                                            </div>
